...
![MailBoxGuard sensor mounted inside a mailbox, showing the compact enclosed unit with antenna](/blog-images/mailboxguard-installed.jpg)
...
The MailBoxGuard mounts to the interior wall of the mailbox. I used a small patch of double-sided tape. The antenna sits upright inside the enclosure and the whole unit is compact enough that it doesn't interfere with letter delivery.
