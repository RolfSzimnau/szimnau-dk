...
The solution: a lightweight Linux container on the [Proxmox host](/en/blog/proxmox-home-assistant-setup/) that already runs HA. One extra LXC container — Debian 12, 1 vCPU, 512 MB RAM — registered as a self-hosted GitHub Actions runner. It starts automatically with Proxmox and costs essentially nothing in resources.
...
![GitHub self-hosted runner registered with home-network label](/blog-images/Github_Runners.jpg)
