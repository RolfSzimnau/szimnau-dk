...
Seven weeks later I wanted to boost the fans from Home Assistant instead of opening the Fresh app every time. `angoyd/freshintelliventHacs` doesn't offer that — it's still strictly read-only, as described above. The fix was swapping the entire integration for a different community repo, [`Spit68/Fresh-Intellivent-Sky`](https://github.com/Spit68/Fresh-Intellivent-Sky), installed the same way through HACS.
