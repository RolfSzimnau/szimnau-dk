...
<img src="/blog-images/etilbudsavis-shopping-Chip.webp" alt="Home Assistant dashboard showing a shopping cart chip with the number of pending items" style="max-width: 480px; display: block; margin: 2rem auto; border-radius: 12px;" />
