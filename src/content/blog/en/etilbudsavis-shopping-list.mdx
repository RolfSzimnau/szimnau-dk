...
seoTitle: "eTilbudsavis in Home Assistant: Sorted by Store"
...
<img src="/blog-images/etilbudsavis-shopping-Chip.jpg" alt="Home Assistant dashboard showing a shopping cart chip with the number of pending items" style="max-width: 480px; display: block; margin: 2rem auto; border-radius: 12px;" />
...
<img src="/blog-images/etilbudsavis-shopping-list.webp" alt="eTilbudsavis shopping list in the Home Assistant companion app, sorted by store with price and date visible" style="max-width: 360px; display: block; margin: 2rem auto; border-radius: 16px;" />
