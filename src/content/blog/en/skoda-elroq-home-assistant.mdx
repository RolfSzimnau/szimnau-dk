...
The AlertTicker card handles this. Between 21:00 and 06:00, if `binary_sensor.elroq_plugged_in` is off, a warning banner appears across every dashboard view:
