...
**API shutdown — 27 May 2026**

On 27 May 2026, VW required cryptographic app attestation on their API, effectively blocking all open-source projects — including the MySkoda integration for VW, Audi, Škoda and Cupra.

What no longer works: battery status and range, overnight cable-connected warning, calendar-triggered pre-conditioning.

Possible alternatives:
- **OBD-II adapter (OBDLINK MX+, ~€45)** — works, but read-only, no remote commands
- **Volteras** (official partner, subscription) — works, but no HA integration yet
- **Community fix** — free, but unstable
- **EU Data Act, 12 Sept. 2026** — VW legally required to reopen access
