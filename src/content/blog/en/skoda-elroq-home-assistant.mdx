...
VW shut down their cloud API on 27 May 2026, breaking the MySkoda integration for all VW Group cars (VW, Audi, Škoda, Cupra).

What no longer works: battery status and range in the dashboard, overnight cable-connected warning, calendar-triggered pre-conditioning.

| Option | Cost | Status |
|---|---|---|
| OBD-II adapter (OBDLINK MX+) | ~€45 | Works — read-only, no remote commands |
| Volteras (official partner) | Subscription | Works — no HA integration yet |
| Wait for community fix | Free | Unstable |
| EU Data Act | Free | Likely Sept. 2026 — VW legally required to open access |
