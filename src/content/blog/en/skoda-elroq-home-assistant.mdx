...
<div style="background: rgba(239,68,68,0.12); border: 1px solid rgba(239,68,68,0.4); border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.5rem;">
  <strong>Update June 2026:</strong> Volkswagen Group closed their API on 27 May 2026. The MySkoda integration no longer works — battery status, pre-conditioning, and all other sensors are down. Follow <a href="https://github.com/skodaconnect/homeassistant-myskoda/issues">GitHub issues</a> for a potential fix. The rest of this article describes the setup as it worked.
</div>
