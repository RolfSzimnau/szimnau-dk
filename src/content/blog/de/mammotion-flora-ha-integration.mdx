...
Mein Husqvarna 413c lief drei Jahre lang und hatte nie irgendetwas mit Home Assistant zu tun. Nicht über HACS, nicht über inoffizielle Bridges, nicht über sonst irgendetwas. Er mähte nach seinem eigenen Zeitplan in seiner eigenen App, und wenn er im Regen fuhr, dann weil niemand der App gesagt hatte, dass es regnete.

Dramatisch war das nicht. Nur nervig genug, dass ich irgendwann getauscht habe.

Ich ersetzte ihn durch einen **Mammotion Flora** (Luba Mini) Anfang des Jahres — hauptsächlich wegen der echten HA-Integration. Hier ist, was ich nach ein paar Monaten herausgefunden habe.

![Mammotion Flora Mähroboter-Dashboard in Home Assistant mit GPS-Karte, Mähfortschritt und Wochenplan](/blog-images/luba-flora.jpg)

## Einrichtung

Der Flora nutzt GPS + RTK zur Navigation — kein Begrenzungsdraht. Die Grenze wird einmalig in der Mammotion-App gezeichnet, danach hält sich der Mäher innerhalb der Koordinaten. Das Vision Module ist eine kleine Kamera am Gehäuse, die Hindernisse erkennt.

Installation: HACS → Mammotion suchen → mit Konto authentifizieren. Danach erscheinen:
...
`custom:lawn-mower-card` zeigt eine Grafik des Mähers mit Batteriestand. Mushroom-Chips darunter für die Telemetrie:
