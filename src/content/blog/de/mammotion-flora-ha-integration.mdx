...
Als ich Flora Anfang April nach der Winterpause aus der Werkstatt holte, war das Vision Module ausgefallen. Keine schleichende Verschlechterung — über den Winter hatte sich Feuchtigkeit in einem der Kameraobjektive gebildet, wie man auf dem Foto sehen kann. Es hörte einfach auf, etwas zu erkennen. Ich kontaktierte den Mammotion-Support und erwartete die übliche Troubleshooting-Schleife. Sie diagnostizierten das Problem schnell und schickten ein Ersatzmodul innerhalb weniger Tage, ohne Diskussion. Das Ersatzmodul läuft seitdem problemlos.

Das Modul kann ausfallen. Winterlagerung und Kondensation sind eine Kombination, die man im Blick behalten sollte. Aber der Support hat das vorbildlich geregelt.
...
Dazu kommt ein periodischer "Robot out of task area"-Fehler — immer in der Nähe der No-Go-Zonen rund um die Blumenbeete. Meine Theorie ist Mehrwegeausbreitung: GPS-Signale, die an den festen Gartenstrukturen reflektiert werden und Flora kurzzeitig glauben lassen, sie sei außerhalb der Grenze. Sie hält an und wartet.

Genau hier fehlt der HA-Integration etwas Entscheidendes. Es gibt keinen Fehlercode-Sensor. Keine Push-Benachrichtigung, wenn sie verwirrt mitten im Beet steht — ich muss die Mammotion-App öffnen, um überhaupt zu merken, dass etwas schiefgelaufen ist.
...
Insgesamt: mehr als der richtige Entscheid. Die Fehler sind real, der fehlende Fehlercode-Sensor ist eine echte Lücke — aber ich bin wirklich begeistert von dieser Maschine. Flora ist kein separates Gerät mehr, das einfach herumfährt. Sie ist Teil des Smart Homes, und das möchte man nicht mehr missen, wenn man es einmal erlebt hat.
