...
Sieben Wochen nach der Erstinstallation hatte ich genug davon, für jeden Boost extra zur Fresh-App zu greifen. Die oben beschriebene `angoyd/freshintelliventHacs`-Integration ändert daran nichts — sie bleibt, was sie ist: reine Anzeige. Also flog sie raus, und an ihrer Stelle steht jetzt [`Spit68/Fresh-Intellivent-Sky`](https://github.com/Spit68/Fresh-Intellivent-Sky), ebenfalls aus HACS, aber mit einem völlig anderen Funktionsumfang.
