...
description: "Wie ich einen HA-Startbildschirm mit bedingten Karten, priorisiertem Alert-Ticker und einem Škoda-Bereich der sich je nach Ladestand ändert gebaut habe."
pubDate: 2025-06-27
...
faqs:
  - question: "What is a context-aware Home Assistant dashboard?"
    answer: "A home screen where cards only render when they carry information — conditional cards for running appliances, a priority alert ticker, and sections that change with context, like a Skoda panel that swaps controls depending on whether the charger is connected."
  - question: "Why hide dashboard cards when everything is fine?"
    answer: "A docked vacuum or a locked car is confirmation, not information. Hiding the 'still fine' cards makes screen length itself the signal: a short page means a quiet house."
---
