---
title: "Zirkadianes Licht mit WiZ, das der Farbtemperatur der Sonne folgt"
seoTitle: "Zirkadianes WiZ-Licht folgt der Sonne"
description: "Zirkadiane Beleuchtung mit WiZ-Lampen und der HA-Sonnen-Entität: eine einzige Automatisierung mappt Sonnenhöhe auf Farbtemperatur."
pubDate: 2025-12-12
tags: ["licht", "automatisierung"]
lang: "de"
translationKey: "wiz-circadian-lighting"
heroImage: "/blog-images/hjem_circadian-lighting.jpg"
faqs:
  - question: "How do you build circadian lighting with WiZ bulbs in Home Assistant?"
    answer: "The built-in WiZ integration auto-discovers the bulbs, and one automation running every 30 minutes maps the sun entity's solar elevation to a colour temperature — cool at noon, warm at dusk — only touching lights that are already on."
  - question: "Why not use WiZ's native Dynamic modes?"
    answer: "They run locally on the bulb and can't respond to anything in HA — no conditions, no per-room logic. Building it in HA uses real solar data for your location and stays fully modifiable."
---
