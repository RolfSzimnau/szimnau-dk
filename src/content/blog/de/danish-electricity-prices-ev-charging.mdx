...
Die Automatisierung verwendet `switch.elroq_charging` aus der [MySkoda](https://github.com/skodaconnect/homeassistant-myskoda)-Integration (HACS) zum Starten und Stoppen des Ladevorgangs.
