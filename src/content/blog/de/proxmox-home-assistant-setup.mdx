...
Als erstes nach der Installation empfiehlt sich der Proxmox Post-Install-Helfer von [community-scripts.github.io/ProxmoxVE](https://community-scripts.github.io/ProxmoxVE/) — eine community-gepflegte Sammlung von Skripten für Proxmox. Das Post-Install-Skript entfernt die Abonnement-Meldung, wechselt zum kostenlosen Repository und nimmt sinnvolle Grundeinstellungen vor:
