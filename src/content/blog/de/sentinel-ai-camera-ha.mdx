...
description: "Wie ich die Sentinel-Kamera dazu gebracht habe, nützliche Meldungen zu schicken statt 40 Bewegungsalarme am Tag — eine Automatisierung, ein Stummschalten-Schalter und Aktionsschaltflächen."
pubDate: 2025-02-07
  ...
  - action: notify.alle_enheder
    data:
      ...
      data:
        ...
        entity_id: camera.sentinel_fluent
        camera_stream: true
        image: /api/camera_proxy/camera.sentinel_snapshots_fluent
        actions:
          - action: URI
