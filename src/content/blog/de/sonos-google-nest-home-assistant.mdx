...
description: "Wie ich einen Sonos-Wohnzimmerlautsprecher mit vier Google Nest Audio Lautsprechern per Home Assistant Scripts vereint habe — ohne Drittanbieter-Brücken und ohne Abonnement."
pubDate: 2026-08-14
...
Die Sonos-Integration in HA ist nativ und hervorragend. Sie findet den Lautsprecher automatisch über das lokale Netzwerk — keine Sonos-Cloud-Abhängigkeit für grundlegende Wiedergabesteuerung.

Google-Lautsprecher werden über die Google Home-Integration (oder die Cast-Integration) eingebunden. Beide liefern `media_player`-Entitäten mit Standard-Play/Pause/Lautstärke-Services.
...
Eine mushroom chips-Karte in der Haupt-Hjem-Ansicht für schnelle Einzel-Tippen-Kontrolle:
