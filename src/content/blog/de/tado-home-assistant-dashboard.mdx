---
title: "Ein Tado-Heizungs-Dashboard mit card_mod, das wirklich einen Blick wert ist"
seoTitle: "Tado-Heizungs-Dashboard mit card_mod, das sich lohnt"
...
pubDate: 2025-03-07
tags: ["heizung", "dashboard"]
lang: "de"
translationKey: "tado-home-assistant-dashboard"
heroImage: "/blog-images/klima-tado.jpg"
faqs:
  - question: "What does the Tado integration give you in Home Assistant?"
    answer: "It is built into HA (Tado Internet Bridge and account required): every zone appears as a climate entity with sub-5-second state updates, plus binary sensors for Tado's hardware open-window detection."
  - question: "How does the breathing animation for active heating work?"
    answer: "A card-mod CSS keyframe animation on the mushroom climate card that only runs while hvac_action is heating — five zones in a grid read at a glance because only the active ones pulse."
---
