...
**API-Abschaltung — 27. Mai 2026**

Am 27. Mai 2026 forderte VW kryptografische App-Attestierung für ihre API, was alle Open-Source-Projekte effektiv blockiert — einschließlich der MySkoda-Integration für VW, Audi, Škoda und Cupra.

Was nicht mehr funktioniert: Batteriestatus und Reichweite, nächtliche Kabelwarnung, kalenderbasierte Vorkonditionierung.

Mögliche Alternativen:
- **OBD-II-Adapter (OBDLINK MX+, ~45 €)** — funktioniert, aber nur lesend, keine Fernbefehle
- **Volteras** (offizieller Partner, Abo) — funktioniert, aber noch keine HA-Integration
- **Community-Fix** — kostenlos, aber instabil
- **EU Data Act, 12. Sept. 2026** — VW gesetzlich zur Öffnung des Zugangs verpflichtet
