---
title: "Škoda Elroq und Home Assistant, sechs Monate später"
description: "Was die MyŠkoda-Integration in Home Assistant wirklich bietet, was fehlt, und ein nützliches EV-Dashboard mit Batterie-Fortschritt und Vorwärmung."
pubDate: 2026-04-13
...
faqs:
  ...
  - question: "Funktioniert die MySkoda-Integration in Home Assistant noch?"
    answer: "MySkoda soll im Oktober 2026 nicht mehr funktionieren, sobald das zugrundeliegende Backend abgeschaltet wird. Ich habe meine eigenen Elroq-Automationen auf VW Group Connect umgestellt, eine gepflegte Alternative mit Škoda-Unterstützung. Die Entity-Namen werden zu garage_<autoname>_* und manche Statuswerte ändern die Schreibweise, also prüfe nach dem Wechsel jede Automation."
---
...
Aktueller Stand: [GitHub-Issues](https://github.com/skodaconnect/homeassistant-myskoda/issues).
...
**Update, September 2026 — Abschaltung angekündigt**

Škoda hat angekündigt, dass MySkoda im Oktober 2026 komplett aufhört zu funktionieren, sobald das zugrundeliegende Backend abgeschaltet wird. Eine offizielle Home-Assistant-Integration ist mit dem 2026.10-Release "erwartet", aber das Datum ist nicht bestätigt.

Ich habe meine eigenen Elroq-Automationen bereits auf [VW Group Connect](https://github.com/its-me-prash/vwgroup-connect-ha) umgestellt, eine gepflegte Alternative, die Škoda über mehrere Kanäle unterstützt. Wer noch MySkoda nutzt, sollte VW Group Connect schon jetzt anmelden, statt auf die Abschaltung zu warten — beide laufen problemlos parallel. Eine 1:1-Umbenennung ist es aber nicht: Die Entity-Namen unterscheiden sich (`garage_<autoname>_*`, nicht `skoda_elroq_*`), und mindestens ein Enum-Sensor ändert komplett die Groß-/Kleinschreibung — MySkodas `charging_state` ist kleingeschrieben (`ready_for_charging`), das VW-Group-Connect-Pendant ist großgeschrieben (`READY_FOR_CHARGING`). Prüfe die State-Vergleiche jeder Automation von Hand; verlass dich nicht auf Gleichheit.
