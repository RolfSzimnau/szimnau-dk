...
VW hat seine Cloud-API am 27. Mai 2026 abgeschaltet. Das bricht die MySkoda-Integration für alle Fahrzeuge der VW-Gruppe (VW, Audi, Škoda, Cupra).

Was nicht mehr funktioniert: Batteriestatus und Reichweite im Dashboard, nächtliche Kabelwarnung, kalenderbasierte Vorkonditionierung.

| Lösung | Kosten | Status |
|---|---|---|
| OBD-II-Adapter (OBDLINK MX+) | ~45 € | Funktioniert — nur lesen, keine Befehle |
| Volteras (offizieller Partner) | Abo | Funktioniert — noch keine HA-Integration |
| Auf Community-Fix warten | Kostenlos | Instabil |
| EU Data Act | Kostenlos | Wahrscheinlich Sept. 2026 — VW gesetzlich verpflichtet |
