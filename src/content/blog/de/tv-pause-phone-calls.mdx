---
title: "Der Fernseher pausiert automatisch bei normalen Anrufen und Messenger"
seoTitle: "Fernseher pausiert bei normalen Anrufen und Messenger"
description: "Eine Automatisierung pausiert den TV, sobald ein Telefon klingelt. Normale Anrufe setzen automatisch fort, Messenger-Videoanrufe per Knopf."
pubDate: 2025-10-17
tags: ["medien", "benachrichtigungen", "automatisierung"]
lang: "de"
translationKey: "tv-pause-phone-calls"
heroImage: "/blog-images/tv-pause-on-phone-call-home-assistant.jpg"
faqs:
  - question: "How does Home Assistant know a phone is ringing?"
    answer: "The HA Companion App exposes a phone state sensor (ringing, in_call, offhook, idle). One automation pauses the TV when either phone leaves idle and resumes playback when the call ends."
  - question: "Why do Messenger calls need special handling?"
    answer: "Messenger video calls don't change the Android phone state sensor, so they are detected via the notification sensor instead — and since call end can't be detected reliably, the notification carries a manual resume button."
---
