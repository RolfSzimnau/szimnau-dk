...
description: "Wie ich den Bosch Geschirrspüler über Home Connect eingebunden, ein Dashboard mit Programmwahl und Endzeitkontrolle gebaut und einen Knopf hinzugefügt habe, der die günstigste Stunde findet."
pubDate: 2026-07-10
...
Der Geschirrspüler war das Gerät, von dem ich am wenigsten erwartet hatte. Es ist ein Bosch. Er verbindet sich mit der Bosch Home Connect-App, was in Ordnung ist — aber nur eine weitere App. Ich habe die Home Connect-Integration zu HA hauptsächlich aus Vollständigkeitsgründen hinzugefügt.
...
![Bosch Geschirrspüler-Dashboard in Home Assistant mit Programmwähler, Endzeit und Smart-Scheduling](/blog-images/hvidevarer-appliances.jpg)
...
Der "Günstigste planen"-Knopf ist ein Skript, das Energi Data Service Spotpreise liest, das günstigste kommende 1-Stunden-Fenster vor Mitternacht findet, die Programmlaufzeit addiert und `select.dishwasher_finish_at` auf diesen Zeitpunkt setzt.
