...
**API-nedlukning — 27. maj 2026**

VW krævede den 27. maj 2026 kryptografisk app-attestering på deres API, hvilket effektivt blokerer alle open source-projekter — herunder MySkoda-integrationen for VW, Audi, Škoda og Cupra.

Hvad der ikke virker: batteristatus og rækkevidde, kabeladvarsel om natten, forvarming fra Google Kalender.

Mulige alternativer:
- **OBD-II adapter (OBDLINK MX+, ~500 kr)** — virker, men kun læsning, ingen fjernkommandoer
- **Volteras** (officiel partner, abonnement) — virker, men ingen HA-integration endnu
- **Community-fix** — gratis, men ustabilt
- **EU Data Act, 12. sept. 2026** — VW tvinges lovmæssigt til at åbne adgangen
