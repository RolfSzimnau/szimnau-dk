---
title: "Škoda Elroq og Home Assistant, seks måneder efter"
...
faqs:
  ...
  - question: "Virker MySkoda-integrationen i Home Assistant stadig?"
    answer: "MySkoda forventes at holde op med at virke i oktober 2026, når den bagvedliggende API lukkes. Jeg har flyttet mine egne Elroq-automationer til VW Group Connect, et vedligeholdt alternativ der understøtter Škoda. Entitetsnavne bliver til garage_<bilnavn>_*, og nogle tilstandsværdier skifter case, så tjek alle automationer efter skiftet."
---
...
**Opdatering, september 2026 — MySkoda lukker**

Škoda har meddelt at MySkoda helt holder op med at virke i oktober 2026, når den bagvedliggende API lukkes. En officiel Home Assistant-integration er "forventet" med 2026.10-udgivelsen, men datoen er ikke bekræftet.

Jeg har flyttet mine egne Elroq-automationer til [VW Group Connect](https://github.com/its-me-prash/vwgroup-connect-ha), et vedligeholdt alternativ der allerede understøtter Škoda via flere kanaler. Kører du stadig MySkoda, så få VW Group Connect logget ind allerede nu i stedet for at vente til det går galt — de to kan sagtens køre side om side. Forvent dog ikke en 1:1-omdøbning: entitetsnavnene er anderledes (`garage_<bilnavn>_*`, ikke `skoda_elroq_*`), og mindst én enum-sensor skifter helt case — MySkodas `charging_state` er lowercase (`ready_for_charging`), VW Group Connects tilsvarende er uppercase (`READY_FOR_CHARGING`). Tjek hver automations state-sammenligninger manuelt; antag ikke at de matcher.
