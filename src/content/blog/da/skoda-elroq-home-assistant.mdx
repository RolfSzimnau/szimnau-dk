...
VW lukkede sin cloud-API den 27. maj 2026. Det bryder MySkoda-integrationen for alle VW-gruppe biler (VW, Audi, Škoda, Cupra).

Hvad der ikke virker: batteristatus og rækkevidde i dashboardet, kabeladvarsel om natten, forvarming fra Google Kalender.

| Løsning | Pris | Status |
|---|---|---|
| OBD-II adapter (OBDLINK MX+) | ~500 kr | Virker — kun læsning, ingen kommandoer |
| Volteras (officiel partner) | Abonnement | Virker — ingen HA-integration endnu |
| Vente på community-fix | Gratis | Ustabilt |
| EU Data Act | Gratis | Sandsynligvis sept. 2026 — VW tvinges lovmæssigt |
