...
<div style="background: rgba(239,68,68,0.12); border: 1px solid rgba(239,68,68,0.4); border-radius: 12px; padding: 1rem 1.25rem; margin-bottom: 1.5rem;">
  <strong>Opdatering juni 2026:</strong> Volkswagen-gruppen lukkede deres API den 27. maj 2026. MySkoda-integrationen virker ikke længere — batteristatus, forvarming og alle andre sensorer er nede. Følg <a href="https://github.com/skodaconnect/homeassistant-myskoda/issues">GitHub-issues</a> for et evt. fix. Resten af artiklen beskriver opsætningen som den fungerede.
</div>
