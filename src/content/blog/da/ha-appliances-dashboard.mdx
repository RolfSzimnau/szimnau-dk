---
title: "Sådan planlægger jeg Bosch-opvaskemaskinen i Home Assistant efter elprisen"
seoTitle: "Bosch-opvaskemaskinen efter elpris i Home Assistant"
description: "Opvaskemaskinen via Home Connect: dashboard med programvalg og sluttidskontrol, plus en knap der finder den billigste time at køre den i."
pubDate: 2025-08-22
tags: ["energi", "dashboard"]
lang: "da"
...
"Planlæg billigst"-knappen er et script der læser [Energi Data Service](https://www.energidataservice.dk/) spotpriser (HACS-integration, gratis dansk offentlig API), finder det billigste kommende 1-times vindue inden midnat, lægger programmets køretid til, og sætter `select.dishwasher_finish_at` til det tidspunkt.
