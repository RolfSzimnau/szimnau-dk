...
Opvaskemaskine-notifikationen virkede perfekt i måneder. Så en dag gjorde den det ikke. `notify.android_tv`-servicen var stille og roligt forsvundet efter en HA-genstart, og jeg fandt først ud af det da jeg stod i køkkenet og ventede på en alarm der aldrig kom.
