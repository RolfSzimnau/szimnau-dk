...
seoTitle: "Fresh Intellivent Sky i Home Assistant via Bluetooth-proxy"
...
Et råt 16-bit tal, lige fra enhedens eget register, uden division eller reference at holde det op imod. De to automationer fra afsnittet ovenfor kunne derfor ikke bare kopieres over med et nyt entity-navn — indtil jeg tænkte mig lidt bedre om. Den gamle `angoyd`-integration parser slet ikke selv BLE-data; den læner sig op ad et separat bibliotek, [`pyfreshintellivent`](https://github.com/LaStrada/pyfreshintellivent). Dét biblioteks `sensors.py` læser **samme karakteristik** (`528b80e8-…`, bogstaveligt navngivet "Sensor data" i protokol-dokumentationen) på **samme byte-offset** som `humidity_raw` ovenfor — og regner den om:
