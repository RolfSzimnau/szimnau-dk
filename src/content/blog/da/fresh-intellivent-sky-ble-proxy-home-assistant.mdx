...
Syv uger senere blev jeg kontaktet af en fra Spittie.dk — et dansk site for Home Assistant-entusiaster — der gjorde mig opmærksom på et repo, jeg ikke selv havde fundet: [`Spit68/Fresh-Intellivent-Sky`](https://github.com/Spit68/Fresh-Intellivent-Sky). Navnesammenfaldet er nok ikke tilfældigt. `angoyd/freshintelliventHacs` — integrationen omtalt ovenfor — er stadig rent skrivebeskyttet, uanset hvor mange gange man genindlæser den; det nye repo er noget helt andet, installeret på samme måde via HACS, men med et helt andet sæt entiteter i den anden ende.
