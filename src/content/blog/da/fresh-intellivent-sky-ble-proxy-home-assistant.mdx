...
Syv uger senere er jeg holdt op med at gide åbne Fresh-appen, hver gang nogen har taget et langt bad og ventilatoren skal boost'es. `angoyd/freshintelliventHacs` — integrationen omtalt ovenfor — kan ikke det, uanset hvor mange gange man genindlæser den. Løsningen blev at rive integrationen op med rode og sætte et andet community-repo i stedet: [`Spit68/Fresh-Intellivent-Sky`](https://github.com/Spit68/Fresh-Intellivent-Sky) — samme fremgangsmåde via HACS som første gang, men et helt andet sæt entiteter i den anden ende.
