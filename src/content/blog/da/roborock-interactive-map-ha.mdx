...
description: "Roborock S8 MaxV med interaktivt støvsugerkort, rum-segment-rengøring og vedligeholdelsessensorer der advarer dig inden børsten brænder ud."
pubDate: 2026-06-12
...
![Roborock S8 MaxV dashboard i Home Assistant med interaktivt rumkort og vedligeholdelsessensorer](/blog-images/robot-roborock.jpg)
...
Find dine rum-ID'er: Udviklingsværktøjer → Skabelon, evaluer `{{ state_attr('vacuum.roborock_s8_maxv', 'room_list') }}`. ID'erne er heltal tildelt da kortet blev oprettet i appen. Mine starter ved 16 — dine vil sandsynligvis være anderledes.
