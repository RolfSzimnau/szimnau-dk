...
Sonos-integrationen i HA er native og solid. Den finder højttaleren automatisk over lokalt netværk — ingen afhængighed af Sonos-skyen til basal afspilningsstyring.

Google-højttalere integreres via Google Home-integrationen (eller Cast-integrationen). Begge giver `media_player`-entiteter med standard play/pause/volumen-services.
...
Jeg har en mushroom chips-card i hoved-Hjem-visningen til hurtig ét-tryk-styring:
