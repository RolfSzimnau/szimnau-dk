...
Da jeg tog Flora ud af værkstedet i starten af april efter vinterpausen, var Vision-modulet gået i stykker. Ikke gradvis forringelse — der havde dannet sig fugt inde i det ene kameraobjektiv over vinteren, det kan man se på billedet. Det holdt simpelthen op med at se noget. Jeg kontaktede Mammotion support og forventede den sædvanlige troubleshooting-runddans. De diagnosticerede det hurtigt og sendte et nyt modul inden for et par dage, uden diskussion. Det nye kører uden problemer siden.

Modulet kan altså fejle. Vinterpause og fugtdannelse er en kombination, man skal have i baghovedet. Men supporten klarede det flot.
...
Jeg kæmper også med en periodisk "Robot out of task area"-fejl — altid i nærheden af no go-zonerne rundt om blomsterbedene. Min teori er multipath-interferens: GPS-signalerne kaster sig af de faste barrierer, så Flora et kort sekund tror, hun er stukket af over grænsen. Så stopper hun og venter.

Det er netop her, integrationen til Home Assistant virkelig mangler. Der er ingen error code-sensor. Ingen push-besked, når hun sidder forvirret midt i bedene — jeg er nødt til at åbne Mammotion-appen for at opdage, at noget er galt.
...
Alt i alt: mere end det hele værd. Fejlene er reelle, og den manglende error-sensor er en ægte mangel — men jeg er oprigtigt vild med maskinen. Flora er ikke længere et separat apparat der bare kører rundt. Hun er en del af smart-hjemmet, og det er svært at give afkald på, når man først har prøvet det.
