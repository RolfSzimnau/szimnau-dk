...
Min Husqvarna 413c kørte i tre år uden nogensinde at have det mindste at gøre med Home Assistant. Ikke via HACS, ikke via uofficielle broer, ikke via noget som helst. Den klippede på sin egen tidsplan i sin egen app, og hvis den kørte i regnvejr var det fordi ingen havde fortalt appen at det regnede.

Det var der egentlig ikke noget dramatisk ved. Bare irriterende nok til at jeg til sidst skiftede.

Jeg erstattede den med en **Mammotion Flora** (Luba Mini) tidligere i år. Primært fordi den har en rigtig HA-integration. Her er hvad jeg har fundet ud af efter nogle måneder med den.

![Mammotion Flora plæneklipper-dashboard i Home Assistant med GPS-kort, fremdriftsstatus og ugentlig tidsplan](/blog-images/luba-flora.jpg)

## Opsætning

Flora bruger GPS + RTK til navigation — intet perimeterkabel. Grænsen tegnes i Mammotion-appen én gang, og derefter holder klipperen sig inden for koordinaterne. Vision-modulet er et lille kamera på kroppen der registrerer forhindringer.
...
`custom:lawn-mower-card` viser en grafik af klipperen med batteriniveau. Mushroom chips nedenunder med telemetri:
