...
seoTitle: "eTilbudsavis i Home Assistant: sorteret efter butik"
...
tags: ["indkøb", "automatisering"]
lang: "da"
translationKey: "etilbudsavis-shopping-list"
heroImage: "/blog-images/etilbudsavis-notification.webp"
faqs:
  - question: "What does the eTilbudsavis integration add to a Home Assistant shopping list?"
    answer: "The CagosDk HACS integration creates a todo list where items carry the store name and current offer price in the description, sorted by store, so the list groups itself by where each offer is valid."
  - question: "How do the store proximity notifications work?"
    answer: "HA zones are defined around each store, and an automation matches the zone name against item descriptions on arrival — walking into Bilka pushes a notification listing only the items on offer there. It requires maintaining a zone per store you shop in."
---
...
<img src="/blog-images/etilbudsavis-shopping-Chip.jpg" alt="Home Assistant dashboard med et indkøbskurv-chip der viser antal varer på listen" style="max-width: 480px; display: block; margin: 2rem auto; border-radius: 12px;" />
...
<img src="/blog-images/etilbudsavis-shopping-list.webp" alt="eTilbudsavis indkøbsliste i Home Assistant companion-appen, sorteret efter butik med pris og dato synlig" style="max-width: 360px; display: block; margin: 2rem auto; border-radius: 16px;" />
