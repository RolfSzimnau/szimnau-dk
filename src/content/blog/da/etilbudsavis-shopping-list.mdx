...
<img src="/blog-images/etilbudsavis-shopping-Chip.webp" alt="Home Assistant dashboard med et indkøbskurv-chip der viser antal varer på listen" style="max-width: 480px; display: block; margin: 2rem auto; border-radius: 12px;" />
